 ...
 */
let petsUnion = animalPets.union(mythicalPets)
print(petsUnion)
 ...
 */
let petsIntersection = animalPets.intersection(mythicalPets)
print(petsIntersection)
 ...
 */
let removedPet = animalPets.remove("🐶 Mango") ?? "Mango does no exist"
print(removedPet)
/*:
